...
internal object TermsLevel5 {
    ...
    val terms: List<Term> = listOf(
        ...
        t(
            ...
            explicit = "{G} goes over {R+} shoulders and chest with nails and teeth [adv_rough] and stops just short of leaving anything behind.",
        ...
        t(
            ...
            base = "{G} and {R} wrestle for position for two minutes. Whoever ends up on top pins the other down and uses his hands and mouth on him for the next two.",
            explicit = "{G} and {R} actually wrestle for it for two minutes. Whoever comes out on top pins the other flat and works him over with hands and mouth for the next two.",
        ...
        t(
            ...
            explicit = "{SUB} wears #blindfold# and is locked in #cuffs#, and {DOM} throws #TOY#, his mouth and #ice# at him in no pattern at all.",
            benefit = GIVER, type = BenefitType.RESTRAINT_CONTROL,
            gCon = PartyConstraint.DOMINANT, rCon = PartyConstraint.SUBMISSIVE,
