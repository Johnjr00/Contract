...
internal object ConsiderationsNonSexual {
    ...
    val actions: List<ConsiderationAction> = listOf(
        ...
        c(
            ...
            title = "Scalp massage",
            base = "{G} works {R+} scalp with his fingertips [adv_pressure_light], covering the whole head.",
            explicit = "{G} takes {R+} head in both hands and works his scalp [adv_pressure_light] until he goes loose.",
        ...
        c(
            ...
            title = "Jaw and face",
            base = "{G} works {R+} jaw, temples and cheekbones [adv_pressure_light] with his thumbs.",
            explicit = "{G} holds {R+} face and works his jaw, temples and cheekbones [adv_pressure_light] with both thumbs.",
        ...
        c(
            ...
            base = "{G} works {R+} neck and both shoulders [adv_pressure_firm], thumbs either side of the spine.",
        ...
        c(
            ...
            title = "Upper back",
            base = "{G} works {R+} upper back [adv_pressure_deep], following the inside edge of each shoulder blade.",
        ...
        c(
            ...
            title = "Lower back",
            base = "{G} works {R+} lower back [adv_pressure_firm] with the heels of both hands.",
            explicit = "{G} puts the heels of both hands into {R+} lower back and works it [adv_pressure_deep].",
        ...
        c(
            ...
            base = "{G} works each of {R+} arms from shoulder to wrist, then the palm and every finger.",
            explicit = "{G} works each of {R+} arms shoulder to wrist [adv_pressure_firm], then opens the palm and pulls every finger.",
        ...
        c(
            ...
            base = "{G} works {R+} buttocks and hips [adv_pressure_deep], one side at a time.",
        ...
        c(
            ...
            base = "{G} uses #lubricant# and works the ring of muscle itself [adv_pressure_light], without going in.",
            explicit = "{G} slicks him with #lubricant# and works the muscle itself [adv_pressure_light] until it starts to give, and still does not go in.",
        ...
        c(
            ...
            title = "Inner thighs",
            base = "{G} works each of {R+} inner thighs from the knee up, stopping short of the groin.",
            explicit = "{G} works each of {R+} inner thighs from the knee up [adv_pressure_firm] and stops just short of his groin every time.",
        ...
        c(
            ...
            base = "{G} works each of {R+} calves, then the arch and heel of each foot with both thumbs.",
            explicit = "{G} works each of {R+} calves [adv_pressure_deep], then digs both thumbs into each arch and heel.",
        ...
        c(
            ...
            title = "Groin",
            base = "{G} works the hip creases and the area around {R+} cock without touching the shaft.",
            explicit = "{G} works {R+} hip creases and everything around his cock and deliberately never touches the shaft.",
        ...
        c(
            ...
            title = "Oiled back",
            base = "{G} warms #massage_oil# and works {R+} whole back in long strokes, shoulders to waist.",
            explicit = "{G} warms #massage_oil#, pours it down {R+} spine and works his whole back in long, greedy strokes.",
        ...
        c(
            ...
            base = "{G} drips warm wax from #massage_candle# along {R+} back, then works it in [adv_pressure_firm].",
            explicit = "{G} tips #massage_candle# down {R+} spine, listens to him react, then works the wax in [adv_pressure_firm].",
            acts = setOf("massage_candle", "warm_wax"),
            equip = setOf(Equipment.MASSAGE_CANDLE),
            timers = listOf(tm("Wax", 30), tm("Working it in", 90))
        ),
        c(
        ...
        c(
            ...
            base = "{G} and {R} work each other's necks and shoulders at the same time, sitting face to face.",
            explicit = "{G} and {R} sit face to face and work each other's necks and shoulders at once, and neither stops first.",
        ...
        c(
            ...
            base = "{G} works four areas of {R+} body in turn: shoulders, lower back, buttocks and each thigh.",
            explicit = "{G} works {R} over in four timed passes — shoulders, lower back, ass, then each thigh — and does not cut any of them short.",
        ...
        c(
            ...
            base = "{G} works {R+} mouth, then his neck, then his chest with his mouth, one minute each.",
            explicit = "{G} works {R+} mouth, neck and chest in turn [adv_kiss], a minute each, and does not rush any of them.",
        ...
        c(
            ...
            base = "{G} works {R+} chest and each nipple with his mouth [adv_kiss], alternating between them.",
            explicit = "{G} works {R+} chest and nipples with his mouth [adv_kiss], sucking one while his fingers work the other.",
        ...
        c(
            ...
            title = "One ear",
            base = "{G} works one of {R+} ears with his mouth — outer edge first, then the lobe.",
            explicit = "{G} takes one of {R+} ears in his mouth, works the outer edge, then sucks the lobe and holds it.",
            acts = setOf("ear_play"),
        ...
        c(
            ...
            title = "Both ears",
            base = "{G} works both of {R+} ears in turn with his mouth, holding his head still by the jaw.",
            explicit = "{G} holds {R+} head still by the jaw and works both ears in turn, and he is not allowed to turn away.",
            acts = setOf("ear_play"),
        ...
        c(
            ...
            base = "{G} works {R+} ear and, between passes, [tone_whisper] into it and [v_praise].",
            explicit = "{G} works {R+} ear and, in the gaps, [tone_whisper] into it and [v_praise] close enough for him to feel every word.",
        ...
        c(
            ...
            base = "{G} works {R+} ear and [v_talk_dirty], spelling out exactly what he intends to do to him later.",
            explicit = "{G} works {R+} ear and [v_talk_dirty], spelling out in detail exactly what he is going to do to him later.",
        ...
        c(
            ...
            base = "{G} works {R+} ear and [tone_whisper] into it low enough that {R} feels it more than hears it.",
            explicit = "{G} works {R+} ear and [tone_whisper] into it so low that he feels it more than he hears it.",
            acts = setOf("ear_play", "dirty_talk"),
        ...
        c(
            ...
            base = "{G} and {R} lie face to face on their sides and work each other's ears at the same time.",
            explicit = "{G} and {R} lie face to face and work each other's ears at once, and neither one stops first.",
        ...
        c(
            ...
            base = "{G} works {R+} shoulders and leans down to work his ear with his mouth without stopping his hands.",
            explicit = "{G} keeps working {R+} shoulders [adv_pressure_firm] and works his ear with his mouth at the same time. His hands do not stop.",
        ...
        c(
            ...
            base = "{G} works {R+} ear for a minute, then works his way down and [v_suck] him, then comes back up to the ear.",
            explicit = "{G} works {R+} ear for a minute, goes down and [v_suck] him, then comes straight back up to the ear.",
        ...
        c(
            ...
            base = "{G} works {R+} ear with his mouth while using #TOY# on him.",
            explicit = "{G} works {R+} ear with his mouth and works #TOY# on him at the same time, and neither stops.",
        ...
        c(
            ...
            base = "{R} is restrained with #cuffs# and {G} works both his ears with his mouth for the full time.",
            explicit = "{R} is locked in #cuffs# and {G} works both his ears with his mouth for the whole time, and he cannot do a thing about it.",
        ...
        c(
            ...
            base = "{G} [v_pin] {R} and works his ear with his mouth while he stays pinned, [tone_whisper] into it throughout.",
            explicit = "{G} [v_pin] {R} down and works his ear with his mouth while he stays pinned, [tone_whisper] into it the whole time.",
            acts = setOf("ear_play", "pinning"),
            blocks = setOf(Boundary.NO_ROUGH_SEX),
            timers = listOf(tm("Pinned and worked", 120))
        )
    )
}
