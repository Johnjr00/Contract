...
internal object ClimaxTerms {
    ...
    val terms: List<Term> = listOf(
        ...
        t(
            ...
            base = "{G} [v_stroke] {R+} cock with #lubricant# and kisses him [adv_kiss_deep] until he finishes. If the timer ends first, the same grip and pace continue until he does.",
        ...
        t(
            ...
            base = "{G} kisses and sucks {R+} neck and [v_stroke] his cock with #lubricant# until he finishes. If the timer ends first, he keeps his mouth on his neck and his hand moving until he does.",
            explicit = "{G} kisses and sucks {R+} neck and [v_stroke] his cock with #lubricant# until he [v_come]. If the timer ends first neither the mouth nor the hand stops until he is done.",
            benefit = RECEIVER, type = BenefitType.HAND_STIMULATION_RECIPIENT,
        ...
        t(
            ...
            base = "{G} sucks {R+} ear and [v_stroke] his cock with #lubricant# until he finishes. If the timer ends first, both continue exactly as they are until he does.",
            explicit = "{G} sucks {R+} ear and [v_stroke] his cock with #lubricant# until he [v_come]. If the timer ends first, both carry on exactly as they are until he is done.",
        ...
        t(
            ...
            base = "{G} [v_stroke] {R+} cock with #lubricant# and [tone_moan] straight into his ear until he finishes. If the timer ends first, he keeps the same pace and does not go quiet until he does.",
            explicit = "{G} strokes {R+} cock with #lubricant# and [tone_moan] straight into his ear until he [v_come]. If the timer ends first he keeps the pace and does not shut up until he is done.",
            benefit = RECEIVER, type = BenefitType.EAR_PLAY_RECIPIENT,
            acts = setOf("ear_play"),
            equip = setOf(Equipment.LUBRICANT),
        ...
        t(
            ...
            base = "{G} [v_stroke] {R+} cock and [tone_whisper] explicit instructions straight into his ear until he finishes. If the timer ends first, he keeps talking and keeps the same pace until he does.",
            explicit = "{G} strokes {R+} cock and [tone_whisper] [n_dirty_talk] straight into his ear until he [v_come]. If the timer ends first he keeps talking and does not change the pace until he is done.",
            benefit = RECEIVER, type = BenefitType.EAR_PLAY_RECIPIENT,
        ...
        t(
            ...
            base = "{G} kisses {R} [adv_kiss_deep] while running #TOY# on him and [v_stroke] his cock until he finishes. If the timer ends first, nothing changes until he does.",
            explicit = "{G} kisses {R} [adv_kiss_deep], runs #TOY# on him and [v_stroke] his cock at the same time until he [v_come]. If the timer ends first, nothing changes at all until he is done.",
            benefit = RECEIVER, type = BenefitType.TOY_RECIPIENT,
        ...
        t(
            ...
            base = "{G} [v_stroke] {R+} cock [adv_grip], using plenty of #lubricant#, thirty seconds slow then thirty seconds fast, repeating that cycle without a break until he finishes. If the timer ends first, he keeps the same cycle going until he does.",
        ...
        t(
            ...
            base = "{G} kisses and sucks {R+} chest, neck and stomach while he [v_stroke] his cock with #lubricant# until he finishes. If the timer ends first, both continue as they are until he does.",
            explicit = "{G} kisses and sucks {R+} chest, neck and stomach while he [v_stroke] his cock with #lubricant# until he [v_come]. If the timer ends first, both carry on exactly as they are until he is done.",
            benefit = RECEIVER, type = BenefitType.HAND_STIMULATION_RECIPIENT,
        ...
        t(
            ...
            base = "{G} alternates between {R+} neck and both ears with his mouth while he [v_stroke] his cock until he finishes. If the timer ends first, he keeps moving between them at the same pace until he does.",
            explicit = "{G} moves between {R+} neck and both ears with his mouth while he [v_stroke] his cock until he [v_come]. If the timer ends first he keeps moving between them at that pace until he is done.",
            benefit = RECEIVER, type = BenefitType.EAR_PLAY_RECIPIENT,
        ...
        t(
            ...
            base = "{G} kisses {R} [adv_kiss_deep] without breaking off and [v_stroke] his cock with #lubricant# until he finishes. If the timer ends first, neither the kissing nor the hand stops until he does.",
            explicit = "{G} kisses {R} [adv_kiss_deep] without once breaking off and strokes his cock with #lubricant# until he [v_come]. If the timer ends first, neither stops until he is done.",
            benefit = RECEIVER, type = BenefitType.HAND_STIMULATION_RECIPIENT,
        ...
        t(
            ...
            explicit = "{G} lies face down and stays flat. {R} [v_enter] him with #lubricant#, pins his shoulders down and fucks him [adv_thrust_hard] until he [v_come_in] him and gives him [n_load]. He stays buried for a slow count of twenty, then pulls out. If the timer ends first he keeps that exact rhythm going until he is done.",
            benefit = RECEIVER, type = BenefitType.PENETRATION_RECIPIENT,
